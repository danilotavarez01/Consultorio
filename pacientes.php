        ...
        <div class="row">
            ...
            <div class="col-md-10 content">
                ...
                <div class="form-group mb-3">
                    <input type="text" id="searchPaciente" class="form-control" placeholder="Buscar paciente por nombre, apellido o CEDULA...">
                </div>
                            ...
                            while($row = $stmt->fetch(PDO::FETCH_ASSOC)) {
                                ...
                                if (!empty($row['foto'])) {
                                    ...
                                    if (file_exists($rutaFoto)) {
                                        ...
                                        echo "<div class='foto-paciente-placeholder bg-warning' style='color: #856404;' title='Archivo no encontrado'>404</div>";
                                    }
                                } else {
                                    echo "<div class='foto-paciente-placeholder'>Sin<br>Foto</div>";
                                }
                                echo "</td>";
                                echo "<td>".$row['id']."</td>";
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#nuevoPacienteModal').on('hidden.bs.modal', function () {
                ...
                $('#camera').hide();
                $('#fotoPreview').hide();
                $('#btnStartCamera').prop('disabled', true).text('Iniciar cámara');
                $('#btnCapturePhoto').prop('disabled', true);
                $('#inputFoto').prop('disabled', false);
            });

            // Formulario nueva enfermedad
            $('#formNuevaEnfermedad').submit(function(e) {
                e.preventDefault();
                
                var nombre = $('#nombreEnfermedad').val();
                var descripcion = $('#descripcionEnfermedad').val();
                    ...
                    success: function(response) {
                        ...
                        if (data.success) {
                            ...
                            $('select[name="enfermedades[]"]').append(
                                '<option value="' + data.id + '">' + nombre + '</option>'
                            );
                            ...
                            alert('Enfermedad creada exitosamente');
                        } else {
