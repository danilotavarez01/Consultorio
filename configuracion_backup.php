                ...
                <form id="formNuevoRol">
                    <div class="modal-body">
                        <div class="form-group">
                            ...
                            <input type="text" id="nombre_rol" class="form-control" required 
                                   placeholder="Ej: recepcionista, enfermero, asistente">
                            <small class="form-text text-muted">Solo letras minúsculas, números y guiones bajos</small>
                        </div>
                        <div class="form-group">
                            <label>Descripción</label>
                            <input type="text" id="descripcion_rol" class="form-control" required 
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" value="manage_patients" id="perm_manage_patients">
                                        <label class="form-check-label" for="perm_manage_patients">Gestionar Pacientes</label>
                                    </div>
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" value="view_patients" id="perm_view_patients">
                                        <label class="form-check-label" for="perm_view_patients">Ver Pacientes</label>
                                    </div>
                                    
                                    <h6 class="mt-3">Citas y Agenda</h6>
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" value="manage_appointments" id="perm_manage_appointments">
                                        <label class="form-check-label" for="perm_manage_appointments">Gestionar Citas</label>
                                    </div>
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" value="view_schedule" id="perm_view_schedule">
                                        <label class="form-check-label" for="perm_view_schedule">Ver Agenda</label>
                                    </div>
                                    
                                    <h6 class="mt-3">Consultas Médicas</h6>
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" value="manage_consultations" id="perm_manage_consultations">
                                        <label class="form-check-label" for="perm_manage_consultations">Gestionar Consultas</label>
                                    </div>
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" value="view_medical_history" id="perm_view_medical_history">
                                        <label class="form-check-label" for="perm_view_medical_history">Ver Historial Médico</label>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <h6>Facturación</h6>
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" value="manage_billing" id="perm_manage_billing">
                                        <label class="form-check-label" for="perm_manage_billing">Gestionar Facturación</label>
                                    </div>
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" value="view_reports" id="perm_view_reports">
                                        <label class="form-check-label" for="perm_view_reports">Ver Reportes</label>
                                    </div>
                                    
                                    <h6 class="mt-3">Inventario</h6>
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" value="manage_inventory" id="perm_manage_inventory">
                                        <label class="form-check-label" for="perm_manage_inventory">Gestionar Inventario</label>
                                    </div>
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" value="manage_procedures" id="perm_manage_procedures">
                                        <label class="form-check-label" for="perm_manage_procedures">Gestionar Procedimientos</label>
                                    </div>
                                    
                                    <h6 class="mt-3">Administración</h6>
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" value="manage_users" id="perm_manage_users">
                                        <label class="form-check-label" for="perm_manage_users">Gestionar Usuarios</label>
                                    </div>
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" value="manage_diseases" id="perm_manage_diseases">
                                        <label class="form-check-label" for="perm_manage_diseases">Gestionar Enfermedades</label>
                                    </div>
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" value="system_config" id="perm_system_config">
                                        <label class="form-check-label" for="perm_system_config">Configuración del Sistema</label>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div class="modal-content">
                ...
                <form id="formEditarRol">
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <label>Nombre del Rol</label>
                            <input type="text" id="edit_nombre_rol" class="form-control" required>
                            <small class="form-text text-muted">Solo letras minúsculas, números y guiones bajos</small>
                        </div>
                        <div class="form-group">
                            <label>Descripción</label>
                            <input type="text" id="edit_descripcion_rol" class="form-control" required>
                        </div>
                        <div class="form-group">
                            <label>Permisos</label>
                            <div class="row">
                                <div class="col-md-6">
                                    <h6>Gestión de Pacientes</h6>
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" value="manage_patients" id="edit_perm_manage_patients">
                                        <label class="form-check-label" for="edit_perm_manage_patients">Gestionar Pacientes</label>
                                    </div>
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" value="view_patients" id="edit_perm_view_patients">
                                        <label class="form-check-label" for="edit_perm_view_patients">Ver Pacientes</label>
                                    </div>
                                    
                                    <h6 class="mt-3">Citas y Agenda</h6>
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" value="manage_appointments" id="edit_perm_manage_appointments">
                                        <label class="form-check-label" for="edit_perm_manage_appointments">Gestionar Citas</label>
                                    </div>
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" value="view_schedule" id="edit_perm_view_schedule">
                                        <label class="form-check-label" for="edit_perm_view_schedule">Ver Agenda</label>
                                    </div>
                                    
                                    <h6 class="mt-3">Consultas Médicas</h6>
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" value="manage_consultations" id="edit_perm_manage_consultations">
                                        <label class="form-check-label" for="edit_perm_manage_consultations">Gestionar Consultas</label>
                                    </div>
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" value="view_medical_history" id="edit_perm_view_medical_history">
                                        <label class="form-check-label" for="edit_perm_view_medical_history">Ver Historial Médico</label>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <h6>Facturación</h6>
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" value="manage_billing" id="edit_perm_manage_billing">
                                        <label class="form-check-label" for="edit_perm_manage_billing">Gestionar Facturación</label>
                                    </div>
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" value="view_reports" id="edit_perm_view_reports">
                                        <label class="form-check-label" for="edit_perm_view_reports">Ver Reportes</label>
                                    </div>
                                    
                                    <h6 class="mt-3">Inventario</h6>
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" value="manage_inventory" id="edit_perm_manage_inventory">
                                        <label class="form-check-label" for="edit_perm_manage_inventory">Gestionar Inventario</label>
                                    </div>
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" value="manage_procedures" id="edit_perm_manage_procedures">
                                        <label class="form-check-label" for="edit_perm_manage_procedures">Gestionar Procedimientos</label>
                                    </div>
                                    
                                    <h6 class="mt-3">Administración</h6>
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" value="manage_users" id="edit_perm_manage_users">
                                        <label class="form-check-label" for="edit_perm_manage_users">Gestionar Usuarios</label>
                                    </div>
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" value="manage_diseases" id="edit_perm_manage_diseases">
                                        <label class="form-check-label" for="edit_perm_manage_diseases">Gestionar Enfermedades</label>
                                    </div>
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" value="system_config" id="edit_perm_system_config">
                                        <label class="form-check-label" for="edit_perm_system_config">Configuración del Sistema</label>
                                    </div>
                                </div>
                            </div>
                        </div>
