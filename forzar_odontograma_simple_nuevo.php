        ...
        success: function(data) {
            ...
            const checkAndInitialize = function() {
                ...
                if (typeof window.drawOdontograma === 'function') {
                    ...
                    let delayTime = 400 * initCheckCount;
                    console.log('Función drawOdontograma no encontrada, reintentando en ' + delayTime + 'ms...');
                    setTimeout(checkAndInitialize, delayTime);
                } else {
...
$(document).ready(function() {
    ...
    $(document).on('change', 'select[name="especialidad"], select#especialidad', function() {
        ...
        if (esOdontologia && $('#odontograma-dinamico').length === 0) {
            ...
            window.MOSTRAR_ODONTOGRAMA = true; // Actualizar bandera global
            insertarOdontograma();
        } 
        // Si no es odontología y existe el odontograma, ocultar
            ...
            window.MOSTRAR_ODONTOGRAMA = false; // Actualizar bandera global
