                            ...
                            while($row = $stmt->fetch(PDO::FETCH_ASSOC)) {
                                ...
                                if (!empty($row['foto'])) {
                                    ...
                                    if (file_exists($rutaFoto)) {
                                        ...
                                        echo "<div class='foto-paciente-lista bg-warning d-flex align-items-center justify-content-center' title='Archivo no encontrado'>404</div>";
                                    }
                                } else {
                                    echo "<div class='foto-paciente-lista bg-light d-flex align-items-center justify-content-center'>Sin Foto</div>";
                                }
                                echo "</td>";
                                echo "<td>".$row['id']."</td>";
